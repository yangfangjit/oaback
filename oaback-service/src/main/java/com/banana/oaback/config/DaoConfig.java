...
@ComponentScan("com.banana.oaback")
public class DaoConfig implements EnvironmentAware {
	...
	public SqlSessionFactoryBean sqlSessionFactoryBean(ComboPooledDataSource dataSource) throws IOException {
		...
		sqlSessionFactoryBean.setTypeAliasesPackage("com.banana.oaback.entity");
	...
	public MapperScannerConfigurer mapperScannerConfigurer() {
		...
		mapperScannerConfigurer.setBasePackage("com.banana.oaback.dao");
